...
console.log("tarot_interpretations", data[0].tarot_interpretations);

function randomIntFromInterval(min, max) { // min and max included
  return Math.floor(Math.random() * (max - min + 1) + min)
}

const rndName = randomIntFromInterval(0, 77);
const rndNameQ = randomIntFromInterval(0, data[0].tarot_interpretations[rndName].keywords.length);
const rndPast = randomIntFromInterval(0, 77);
const rndPastMeaning = randomIntFromInterval(0, data[0].tarot_interpretations[rndPast].meanings.light.length);
const rndPresent = randomIntFromInterval(0, 77);
const rndPresentMeaning = randomIntFromInterval(0, data[0].tarot_interpretations[rndPresent].meanings.light.length);
const rndHid = randomIntFromInterval(0, 77);
const rndHidMeaning = randomIntFromInterval(0, data[0].tarot_interpretations[rndHid].keywords.length);
const rndObs = randomIntFromInterval(0, 77);
const rndObsMeaning = randomIntFromInterval(0, data[0].tarot_interpretations[rndObs].meanings.light.length);
const rndSur = randomIntFromInterval(0, 77);
const rndSurMeaning = randomIntFromInterval(0, data[0].tarot_interpretations[rndSur].keywords.length);
const rndAdv = randomIntFromInterval(0, 77);
const rndAdvMeaning = randomIntFromInterval(0, data[0].tarot_interpretations[rndAdv].meanings.light.length);
const rndFor = randomIntFromInterval(0, 77);


function myFunction() {
  document.getElementById("demo01").innerHTML = "The " + data[0].tarot_interpretations[rndName].name + ", " + " who has the qualities of " + data[0].tarot_interpretations[rndNameQ].keywords + ",";
  document.getElementById("demo02").innerHTML = "and who was " + data[0].tarot_interpretations[rndPast].meanings.light[rndPastMeaning] + ",";
  ...
  document.getElementById("demo06").innerHTML = "in the land of " + data[0].tarot_interpretations[rndSur].keywords[rndSurMeaning] + ".";
  document.getElementById("demo07").innerHTML = data[0].tarot_interpretations[rndAdv].meanings.light[rndAdvMeaning] + " , ";
  document.getElementById("demo08").innerHTML = data[0].tarot_interpretations[rndFor].fortune_telling + ".";
  document.getElementById("demo10").innerHTML = "Tarot Cards: " + data[0].tarot_interpretations[rndName].name + ", " + data[0].tarot_interpretations[rndPast].name + ", " + data[0].tarot_interpretations[rndPresent].name + ", " + data[0].tarot_interpretations[rndHid].name + ", " + data[0].tarot_interpretations[rndObs].name + ", " + data[0].tarot_interpretations[rndSur].name + ", " + data[0].tarot_interpretations[rndAdv].name + ", " + data[0].tarot_interpretations[rndFor].name;
